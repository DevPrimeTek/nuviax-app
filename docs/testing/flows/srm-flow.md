# docs/testing/flows/srm-flow.md — SRM Flow (L1–L3)

> Part of: `docs/testing/` | Scenarios: `scenarios/critical.md` (TS-04, TS-05, TS-06)
...
**L1 — Automatic adjustment (no user action required):** ⚠️ NOT IMPLEMENTED (SA-3)
...
4. ⚠️ Task intensity adjustment NOT IMPLEMENTED (SA-4) — `ConfirmSRML2` stamps `confirmed_at` only; no `CreateContextAdjustment` call; next-day task count is unchanged
